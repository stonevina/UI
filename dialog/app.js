require(['./Dialog'], function(Dialog) {
	...
	$('#imgDialog').click(function () {dialog = new Dialog({width: 500, source: 'http://img11.360buyimg.com/da/g14/M00/15/15/rBEhVlJeCegIAAAAAADhV3zKug8AAEO1AGW8mYAAOFv185.jpg', type: 'img'});})
